...
import client.controllers.matchingcontroller.*;

import shared.dataobjects.Profile;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected LoginController log;
    protected LoginServerCommunicator log1;
    protected SignUpController signUpControl;
    protected int SIZE = 20;
    protected MatchController match = new MatchController();
    protected ArrayList<Profile> data = new ArrayList<>(20);
    ...
    public void getLogin(View _view){
        ...
        try {
            log.login(emailSubmit.getText().toString(), passwordSubmit.getText().toString());
        }catch(Exception e) {
            e.printStackTrace();
        }
    ...
    public void getRegister(View _view){
        if(findViewById(R.id.editAge).getVisibility()==View.INVISIBLE){
            ...
            if(register == true) {
                try {
                    signUpControl.signUp(emailSubmit.getText().toString(),passwordSubmit.getText().toString());
                } catch (Exception e) {
                    e.printStackTrace();
                } finally{
                    //loadProfile(_view);
