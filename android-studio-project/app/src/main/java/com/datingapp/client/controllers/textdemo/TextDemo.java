<<<<<<< HEAD:android-studio-project/app/src/main/java/com/datingapp/controller/textDemo/TextDemo.java
package com.datingapp.controller.textDemo;

/*
 * The purpose of this class is to display a text demo of LoginController.
 *
 * @Author: Vincent Yang
 *
 * @Version 1:9/25/2018
...
//        System.out.println("Login User Password:");
//        String password = _sc.nextLine();
//       // _User_account = LoginController.loginAccount(email, password);
//        System.out.println(String.format("The current in session account is %s", _User_account.getEmail()));
//    }
//
//
...
//        System.out.println("Password:");
//        String password = _sc.nextLine();
//        //LoginController.signupAccount(email, password);
//    }


}
>>>>>>> 5e9ad1322c93cc68d97db01878fadc8169d52bd9:android-studio-project/app/src/main/java/com/datingapp/client/controller/textdemo/TextDemo.java
